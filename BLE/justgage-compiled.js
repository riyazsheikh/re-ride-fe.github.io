...
function kvLookup(key, tablea, tableb, defval, datatype, delimiter) {
  ...
  if (!(key === null || key === undefined)) {
    if (tableb !== null && tableb !== undefined && (typeof tableb === 'undefined' ? 'undefined' : _typeof(tableb)) === "object" && key in tableb) {
      val = tableb[key];
      canConvert = true;
    } else if (tablea !== null && tablea !== undefined && (typeof tablea === 'undefined' ? 'undefined' : _typeof(tablea)) === "object" && key in tablea) {
      val = tablea[key];
      canConvert = true;
    } else {
      val = defval;
...
//# sourceMappingURL=justgage-compiled.js.map